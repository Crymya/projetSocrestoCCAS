...
/**
 * @extends ServiceEntityRepository<TacheRealise>
 *
...
class TacheRealiseRepository extends ServiceEntityRepository
{
    ...
    public function save(TacheRealise $entity, bool $flush = false): void
    {
    ...
    public function remove(TacheRealise $entity, bool $flush = false): void
    {
